...
export default function Home() {
  return (
    <section className="max-w-4xl mx-auto mt-20 backdrop-blur-lg bg-white/30 rounded-2xl p-10 md:shadow-xl text-center">
      <h2 className="text-xl md:text-2xl font-bold tracking-widest mb-6 text-sky-900/80">Hi, I'm Zeliha</h2>
      <p className="md:text-lg mb-6">
        ...
        <Link
          ...
          className="font-bold text-teal-700 tracking-widest hover:text-teal-600"
        >
          Liascope.
        </Link>
      </p>
      <div className="flex justify-center my-10 space-x-6">
        ...
        <Button link="/contact" bright={true}>
          Contact
        </Button>
      </div>
    </section>
