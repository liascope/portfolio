...
export default function CaseStudyNav() {
  ...
  `}
    >
      ...
      <ul
        className={`text-md space-y-1 lg:space-y-5  transition-all duration-100 min-[1750px]:opacity-100
  ${open ? 'opacity-100 max-[1750px]:translate-x-0' : 'opacity-0 max-[1750px]:translate-x-5'}
`}
      >
        <h1
          className={`text-base sm:text-lg text-sky-900/70 min-[1750px]:-rotate-10 font-bold uppercase transition-all duration-200 min-[1750px]:mb-10 sm:mb-5 mb-1 ${isSticky ? 'opacity-100' : 'opacity-0'}`}
        >
          {title}
        </h1>
