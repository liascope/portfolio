...
export default function Daycare() {
  return (
    <section className="max-w-6xl md:bg-white/30 md:backdrop-blur-lg rounded-2xl md:p-8 md:shadow-2xl text-base md:text-lg">
      <HeaderCS img="daycare">Daycare App</HeaderCS>
      ...
      <article className="text-sm md:text-base flex flex-col lg:flex-row md:bg-white/40 backdrop-blur-sm md:rounded-2xl md:p-5 lg:p-12 md:shadow hover:scale-105 transition my-10">
        <ul className="list-disc ml-6 space-y-2 md:px-12 text-sm md:text-base">
          <h2 id="key-features" title="Key Features" className="text-xl md:text-2xl font-bold md:tracking-widest uppercase text-sky-900/60 mb-6">
            Key Features
          </h2>
          <li>
        ...
        <article className="flex-1 md:p-5 p-1 scale-90 border-2 rounded-2xl border-dashed border-teal-900/30">
          <h2 id="demo-access" title="Demo Access" className="text-center text-lg md:text-xl font-bold md:tracking-widest uppercase text-sky-900/60">
            Demo Access
          </h2>

          <p className="md:mb-3 text-center">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="text-teal-900/40 text-sm font-bold">
                <tr className="hover:bg-sky-50 transition-colors rounded">
                  ...
                  <td className="px-3 py-2">admin@daycare.com</td>
                  <td className="px-3 py-2">admin-0987</td>
                </tr>
                <tr className="hover:bg-sky-50 transition-colors rounded">
                  <td className="px-3 py-2">Parent</td>
                  <td className="px-3 py-2">noah@daycare.com</td>
                  <td className="px-3 py-2">noah-0987</td>
                </tr>
                <tr className="hover:bg-sky-50 transition-colors rounded">
                  <td className="px-3 py-2">Parent</td>
                  <td className="px-3 py-2">leo@daycare.com</td>
      ...
      <article className="text-sm md:text-base flex flex-col my-10 md:px-12">
        <h2
          id="architecture"
          title="Architecture & Tech Decisions"
          className="md:text-2xl text-xl font-bold md:tracking-widest uppercase text-sky-900/60 mb-8"
        >
          {' '}
        ...
        <p className="mb-4">
          Unlike purely frontend-driven applications, this system relies on a server-controlled data flow using Next.js Server Actions. All mutations
          and data fetching occur server-side, ensuring that no direct database logic is exposed to the client.
        </p>
        ...
        <ul className="list-disc ml-6 space-y-3">
          ...
          <li>
            <strong>Authorization:</strong> Access control is enforced directly within PostgreSQL using Row Level Security (RLS) policies tied to JWT
            role metadata:
          ...
          <li>
            <strong>Styling & Responsiveness: </strong>Tailwind CSS enables a mobile-first, fully responsive interface across dashboards and reporting
            flows.
          </li>
        </ul>
      </article>
      ...
      <article className="my-10 flex flex-col md:flex-row gap-5 items-start">
        <article className="md:bg-white/40 backdrop-blur-sm md:rounded-xl py-6 md:px-10 md:shadow hover:scale-105 transition text-sm flex-1">
          <h2
            id="state-management"
            title="State Management & Data Flow"
            className="text-xl text-center font-bold md:tracking-widest uppercase text-sky-900/60 mb-6"
          >
            State Management & Data Flow
          </h2>

          <p className="mb-4">
            Form state for the caregiver reporting flow is managed via the React Context API to handle structured evaluations, conditional notes, and
            image uploads in a predictable way.
          </p>
      ...
      <footer>
        ...
        <section className="mt-8 md:mt-16 border-t border-sky-700/30 pb-2 pt-8 text-center">
