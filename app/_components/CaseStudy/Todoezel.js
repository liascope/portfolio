...
export default function Todoezel() {
  return (
    <section className="max-w-6xl md:bg-white/30 md:backdrop-blur-lg rounded-2xl md:p-8 md:shadow-2xl text-base md:text-lg">
      <HeaderCS img="todoReact">Task Manager App</HeaderCS>

      <article className="mt-2 mb-10">
        <p className="md:p-6 p-1">
          ...
          supported by visual progress tracking and subtle UX feedback. Initially built in Vanilla JavaScript to validate core functionality, the app
          was refactored into React.js with Redux to become production-ready, scalable, and maintainable
        </p>
        <ul className="list-disc ml-6 md:ml-12 space-y-1 md:space-y-2 text-base">
      ...
      <div className="flex flex-col min-[1750px]:flex-row gap-10 md:mt-0 mt-5 text-sm md:text-base items-center">
        <section>
          ...
          <div className="flex md:flex-row flex-col gap-6">
            <div className="flex flex-1 flex-col p-6 rounded-xl bg-white/50 backdrop-blur-sm shadow-lg hover:scale-105 transition-transform duration-300">
          ...
          <article className="md:p-5 mt-10 flex flex-col md:flex-row justify-between gap-5">
            <ul className="list-disc ml-6 space-y-2 flex-1">
              <h2 id="key-features" title="Key Features" className="md:text-2xl text-xl font-bold md:tracking-widest uppercase text-sky-900/60 mb-6">
                Key Features
              </h2>
              <li>
      ...
      <article className="md:bg-white/40 md:backdrop-blur-sm rounded-2xl text-sm md:text-base md:p-12 md:shadow hover:scale-105 transition my-10">
        <ul className="list-disc ml-6 space-y-2">
          <h2
            id="architecture"
            title="Architecture & Tech Decisions"
            className="text-xl md:text-2xl font-bold md:tracking-widest uppercase text-sky-900/60 mb-6"
          >
        ...
        <div id="state-management" title="State Management & Data Flow" className="my-10">
          <h2 className="text-lg md:text-xl font-semibold uppercase text-sky-900/60 tracking-widest">State Management</h2>
          <p className="mt-2">
