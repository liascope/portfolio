...
export default function AstroReactNext() {
  ...
  return (
    <section className="max-w-6xl md:bg-white/30 md:backdrop-blur-lg rounded-2xl p-1 md:p-8 md:shadow-xl">
      <HeaderCS img="astroReact">Astrology App</HeaderCS>

      <article className="flex flex-col mb-10 mt-2 md:text-lg text-base p-1 md:px-10 gap-5">
        <p>
          Liascope Astrology is a modern astrology charting application designed to provide a clean and beginner-friendly alternative to cluttered and
          visually overwhelming astrology tools. The application allows users to generate and explore multiple astrological charts through an
        ...
        <ul className="list-disc ml-6 md:ml-12 space-y-2">
      ...
      <article className="md:p-12 md:bg-white/40 md:backdrop-blur-sm rounded-xl md:shadow hover:scale-105 transition my-10 p-1">
        <h2
          id="project-evolution"
          title="Project Evolution"
          className="md:text-2xl flex flex-row items-center justify-evenly text-xl font-bold md:tracking-widest cursor-pointer uppercase text-sky-900/60 mb-8"
        >
          Project Evolution: Vanilla JS → React & Next.js{' '}
        </h2>
        <p className="space-y-2 md:px-12 text-sm md:text-base">
        ...
        <h2 className="md:text-xl text-lg font-bold md:tracking-widest uppercase text-sky-900/60 my-6">Improvements & Technical Progress</h2>
        <div className="flex flex-col md:flex-row gap-10 ">
          <div className="flex-1 flex flex-col gap-7 md:gap-10 md:px-2 text-sm md:text-base">
            <p>
            ...
            <p>
              In the React/Next.js version, SVG rendering is handled internally through custom hooks, enabling direct manipulation of chart elements.
              This allows integrated retrograde indicators, dynamic filtering, and responsive scaling directly within the SVG. The application was
              further extended with an AI-powered assistant to support interactive, conversational chart interpretation.
            </p>
            <p>
        ...
        <section className="mt-4">
          <h4 className="md:text-xl text-lg font-bold md:tracking-widest uppercase text-sky-900/50 mb-6 text-center">Project Versions</h4>

          <div className="grid md:grid-cols-2 gap-6 mx-0 md:mx-20">
            <div className="flex flex-col p-6 rounded-xl bg-white/50 backdrop-blur-sm shadow-lg hover:scale-105 transition-transform duration-300">
              <div className="flex items-center md:flex-row-reverse justify-between mb-4">
              ...
              <div className="flex md:flex-row-reverse gap-4 md:justify-self-end">
                <Link
      ...
      <article className="mb-10 mt-2 md:px-10">
        <ul className="list-disc  ml-6 space-y-2 md:px-12 text-sm md:text-base">
          <h2 id="key-features" title="Key Features" className="text-xl md:text-2xl font-bold sm:tracking-widest uppercase text-sky-900/60 mb-6">
            Key Features
          </h2>
          <li>
          ...
          <li>
            <strong>AI Assistant:</strong> Conversational chart interpretation powered by the Gemini API, allowing users to ask questions about their
            charts.
          </li>
          <li>
      ...
      <div className="flex flex-col lg:flex-row gap-10 md:gap-4">
        <article className="md:bg-white/40 md:backdrop-blur-sm rounded-xl md:py-6 md:shadow hover:scale-105 transition">
          <ul className="list-disc flex flex-col gap-2 ml-6 md:px-12 text-sm md:text-base">
            <h2
              id="architecture"
              title="Architecture & Tech Decisions"
              className="text-2xl md:text-xl font-bold md:tracking-widest uppercase text-sky-900/60 mb-6"
            >
            ...
            <li>
              <strong>Context API + React Hook Form</strong> – Used to manage global application state and complex form interactions with a clear and
              predictable data flow, without introducing unnecessary external state libraries.
            </li>
            ...
            <li>
              <strong>TailwindCSS</strong> – Chosen for its utility-first approach to build a clean, consistent, and fully responsive UI efficiently,
              reducing the need for large custom CSS files and improving scalability.
            </li>

            <li>
              <strong>Custom Hooks</strong> – Encapsulate complex logic such as SVG rendering, timezone handling, retrograde calculations, and derived
              chart data, improving readability and reusability.
            </li>
            ...
            <ul className="list-disc space-y-2">
              ...
              <li>
                <strong className="cursor-pointer hover:text-teal-700">
                  <Link href="https://github.com/astsakai/js_astro/tree/master?tab=readme-ov-file#js_astro" target="_blank" rel="noopener noreferrer">
                    Timezone API
                  </Link>
                </strong>{' '}
          ...
          <ul className="space-y-2 text-xs text-sky-900/50 text-justify">
            ...
            <ul className={`overflow-hidden transition-all duration-1000 ease-in-out mb-3 space-y-2 ${readMore ? 'max-h-500' : 'max-h-0'}`}>
              <li>
                ...
                The retrieved data is passed to the Context API. All data and API response are passed to the third-party chart library js_astro in the{' '}
                <code>calcChart</code> function. From the Context API, all values are made available to the corresponding components.
              </li>
