...
export default function About() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 text-teal-900 p-2 sm:p-4">
      <section className="max-w-7xl mx-auto sm:mt-12 backdrop-blur-lg bg-white/30 rounded-2xl p-4 sm:p-10 shadow-xl">
        ...
        <article className="sm:text-lg text-sm flex flex-col gap-6 mb-20 ">
          ...
          <p>
            Alongside personal projects, I actively explore open-source projects, contribute via GitHub pull requests, and continuously expand my
            stack by building real-world applications.
          </p>
