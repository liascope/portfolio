...
- Todoezel App (React + Next.js, TypeSecript) – Clean, responsive productivity app with modular components and persistent state, also refactored from Vanilla JS version.
